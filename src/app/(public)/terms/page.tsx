  ...
  return (
    <div className="max-w-3xl mx-auto py-12 px-4">
      ...
      <div className="space-y-8 text-gray-700 leading-relaxed">
        ...
        <section>
          <h2 className="text-lg font-semibold mb-3">第6条（決済）</h2>
          <ol className="list-decimal list-inside space-y-2">
            <li>本サービスにおける決済は、Stripe（ストライプ）を利用して処理されます。</li>
            <li>クレジットカード情報は本サービスのサーバーには保存されず、Stripeが安全に管理します。</li>
            <li>上演許可に伴う上演料の決済が発生する場合、Stripeの利用規約およびプライバシーポリシーが適用されます。</li>
            <li>決済完了後のキャンセル・返金については、原則として当事者間で協議の上、解決するものとします。運営者は個別の返金対応を行わない場合があります。</li>
          </ol>
        </section>
